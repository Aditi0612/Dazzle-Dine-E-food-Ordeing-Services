...
<head>
    ...
    <link rel="stylesheet" media="screen and (max-width:982px)" href="css/phone.css">
...
<body>
    <nav id="navbar">
        ...
        <ul>
            ...
            <li><a href="menutable.jsp">Menu</a></li>
            
            <li>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</li>
             ...
             ResultSet rsss = psta.executeQuery();
                    while (rsss.next()) {
                        String customer=rsss.getString(1);
                         %>
            <li><a href="menutable.jsp"> <i class='fas fa-user-alt'></i><%out.println(customer); %></a></li>
            
            <% }} catch (Exception e) {
                    out.println(e);
                }%>
            
            <li><a href="myCart.jsp">My Cart<i class='fas fa-cart-arrow-down'></i></a></li>
<!--             
            <li><a href="#">Login
    ...
    <section id="client-section">
        ...
        <div id="clients">
            <div class="box1">
                ...
                <p>A very good place to order food from for any occasions. Delicious food, quick service & easy process <b><i>~ Dinesh Kumar</i></b></p>
            </div>

            <div class="box1">
                <img src="4_star.jpg" alt="">
                <p>Delicious food served at your doorstep within minutes. A must try place for all the foodies out there. <b><i> ~ Supriya Malik</i></b></p>
            </div>

            <div class="box1">
                <img src="4_star.jpg" alt="">
                <p>Huge discounts, delicious food and quick delivery. Nothing could beat the services of Dazzle 'n Dine.<b><i> ~ Rahul Upadhyay</i></b> </p>
            </div> 

            <div class="box1">
                <img src="4_star.jpg" alt="">
                <p>Huge discounts, delicious food and quick delivery. Nothing could beat the services of Dazzle 'n Dine. <b><i> ~ Aviral Mehra</i></b></p>
            </div> 
        </div>
    </section>
